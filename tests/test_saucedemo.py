...
def test_saucedemo(page):
    ...
    continue_shopping = page.locator("[data-test=\"continue-shopping\"]").click()
    expect(page).to_have_url("https://www.saucedemo.com/inventory.html")
    page.pause()
    t_shirt = page.locator("[data-test=\"item-1-title-link\"]").click()
    expect(page).to_have_url("https://www.saucedemo.com/inventory-item.html?id=1")
    add_to_cart2 = page.locator("[data-test=\"add-to-cart\"]").click()